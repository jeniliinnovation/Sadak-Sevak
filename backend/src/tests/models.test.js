...
describe('Database Models Test', () => {
  beforeAll(async () => {
    try {
      ...
      const tables = [
        'likes', 'confirmations', 'comments', 'notifications', 
        'ai_analysis', 'escalation', 'complaints', 'areas', 
        'contractors', 'departments', 'government_admin', 
        'roles_legend', 'summary_table', 'auth'
      ];
